...
import profile1 from '../assets/images/profiles/profile-1.png';
import profile2 from '../assets/images/profiles/profile-2.png';
                    ...
                    <div className="app-header-content">
                        <div className="row justify-content-between align-items-center">
                            ...
                            <div className="app-utilities col-auto">
                                <div
                                    className="app-utility-item app-notifications-dropdown dropdown"
                                >
                                    <Link
                                    ...
                                    >
                                        ...
                                        <span className="icon-badge">3</span> </Link>
                                    {/* ><!--//dropdown-toggle--> */}
                                    ...
                                    >
                                        ...
                                        <div className="dropdown-menu-content">
                                            <div className="item p-3">
                                                <div
                                                    className="row gx-2 justify-content-between align-items-center"
                                                >
                                                    <div className="col-auto">
                                                        <img
